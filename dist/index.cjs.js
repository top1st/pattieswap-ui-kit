...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default['default'].createElement(PriceLink, { href: "", target: "_blank" },
        ...
        React__default['default'].createElement(Text, { ml: "8px", color: color, bold: true }, "$" + cakePriceUsd.toFixed(7)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }));
};
